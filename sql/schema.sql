...
-- equipo — dictado por Ernesto en conversación, no está en
-- Elevate_Spec_Sistema_CI.md. Ver sql/migrations/0002_metas_y_metricas.sql.

-- Config única de toda la organización (una sola fila, id fijo 'global').
...
-- Regla "voluntario": sí/no por célula y mes de si activa el reparto
-- estándar — no carga de monto/destinatario libre.
...
-- Métricas propias por célula (predictoras, no financieras).
